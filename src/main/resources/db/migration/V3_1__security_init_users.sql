...
insert into car_dealership_user (user_id, user_name, email, password, active) values (8, 'test_user', 'test_user@hop.pl','$2a$12$sBy/.dKeXXSuWfti1sqyS./7WndvkSjleax6iD8tzyr5UIyKtd68W' , true);
